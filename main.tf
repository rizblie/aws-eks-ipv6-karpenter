...
locals {
  ...
  tags = {
    Blueprint  = "aws-eks-ipv6-karpenter"
    GithubRepo = "https://github.com/rizblie/aws-eks-ipv6-karpenter"
  }
}
...
module "karpenter_launch_templates" {
  source = "github.com/aws-ia/terraform-aws-eks-blueprints?ref=v4.20.0/modules/launch-templates"
